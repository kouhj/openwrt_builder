...
make image  ADD_LOCAL_KEY=1 PACKAGES="$OPENWRT_IB_PACKAGES" FILES=files DISABLED_SERVICES="$OPENWRT_IB_DISABLED_SERVICES" PREPARE_ROOTFS_HOOK=prepare_rootfs_hook
